package com.sinelynx.grindingrobot.core.designsystem.theme
 ...
 * 在浅色和深色模式下保持一致
 */
val PrimaryDefault = Color(0xFF1C3D76) // 默认主色

val ColorContentContainer = Color(0xFFF0F2F5) // 内容容器背景色

val ColorDevider = Color(0xFFE6E6E6) // 分割线颜色

val ColorTitle = Color(0xFF1A1A1A) // 标题文字颜色

/**
 * 次要色：#E6E6E6
 * 适用场景：次级按钮、次级文本、次级图标等
 * 在浅色和深色模式下保持一致
 * 次级文字颜色
 */
val ColorSecondaryDefault = Color(0xFF595959) // 默认次要色
 ...
 * 三级标题文字颜色
 */
val ColorTertiaryDefault = Color(0xFF999999) // 默认三级标题文字颜色

val ColorGRAY666666 = Color(0xFF666666) // 默认三级标题文字颜色


/**
 * 禁用色与单位底色：0xFFE6E8EB
 * 适用场景：禁用状态、灰色按钮、灰色图标等
 */
val ColorDisabledAndUnitBg = Color(0xFFE6E8EB) // 禁用色与单位底色

/**
 * 提示性文字：0xFFB3B3B3
 * 适用场景：提示性文字等
 */
val ColorHintText = Color(0xFFB3B3B3) // 提示性文字颜色

/**
 * 菜单栏底色：#1F2838
 * 适用场景：菜单栏底色等
 */
val ColorMenuBarBg = Color(0xFF1F2838) // 菜单栏底色

/**
 * 状态栏/IOCN颜色：#0xFF161C27
 * 适用场景：状态栏/IOCN颜色等
 */
val ColorStatusBarAndIcon = Color(0xFF161C27) // 状态栏/IOCN颜色

/**
 * 按钮颜色：#1C3D76
 * 适用场景：按钮颜色
 */
val ColorButtonColor = Color(0xFF1C3D76) // 按钮颜色

/**
 * 蓝色：#0xFF005DFF
 * 适用场景： 链接文字、强调文本等
 */
val ColorBlue = Color(0xFF005DFF) // 蓝色

/**
 * 绿色：#0xFF00D741
 * 适用场景： 成功提示、确认操作等
 */
val ColorGreen = Color(0xFF00D741) // 绿色

/**
 * 黄色：#0xFFFFAA02
 * 适用场景： 警告提示、重要信息等
 */
val ColorYellow = Color(0xFFFFAA02) // 黄色

/**
 * 红色：#0xFFFF2A00
 * 适用场景： 错误提示、删除操作等
 */
val ColorRed = Color(0xFFFF2A00) // 红色

/**
 * 白色：#FFFFFF
 * 适用场景： 背景色、文字色等
 */
val ColorWhite = Color(0xFFFFFFFF) // 白色
