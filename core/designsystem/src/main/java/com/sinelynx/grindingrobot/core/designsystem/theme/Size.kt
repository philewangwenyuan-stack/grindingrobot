...
val SpaceVerticalBottomActionBar = 2.dp

val SpaceHorizontalBottomActionBar = 1.dp
 ...
 */
val SpaceHorizontalXXXLarge = 32.dp // 64px

/**
 * 特大水平间距：24dp (48px)
 * 适用场景：大型容器内部的水平分隔
 */
val SpaceHorizontalXXLarge = 24.dp // 48px

val SpaceHorizontalXLarge = 20.dp // 48px
/**
 * 大水平间距：16dp (32px)
