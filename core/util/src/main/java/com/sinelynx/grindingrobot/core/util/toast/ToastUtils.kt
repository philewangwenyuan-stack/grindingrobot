package com.sinelynx.grindingrobot.core.util.toast
...
import com.sinelynx.grindingrobot.core.util.R
...
object ToastUtils {
    ...
    fun showReplacingSuccess(text: CharSequence) {
        val params = ToastParams()
        params.text = text
        params.style = CustomToastStyle(R.layout.toast_success)
        showReplacing(params)
    }
    ...
    fun showReplacingError(text: CharSequence) {
        val params = ToastParams()
        params.text = text
        params.style = CustomToastStyle(R.layout.toast_error)
        showReplacing(params)
    ...
    fun showErrorDark(text: CharSequence) {
        val params = ToastParams()
        params.text = text
        params.style = CustomToastStyle(R.layout.toast_error_dark)
        Toaster.show(params)
    }

    fun showErrorDark(context: Context, @StringRes resId: Int) {
        val text = context.getString(resId)
        showErrorDark(text)
    }
    ...
    fun showWarningDark(text: CharSequence) {
        val params = ToastParams()
        params.text = text
        params.style = CustomToastStyle(R.layout.toast_warn_dark)
        Toaster.show(params)
    }
    fun showWarningDark(context: Context, @StringRes resId: Int) {
        val text = context.getString(resId)
        showWarningDark(text)
    }
    ...
    private fun showReplacing(text: CharSequence) {
        cancel()
        Toaster.show(text)
    }

    private fun showReplacing(@StringRes resId: Int) {
        cancel()
        Toaster.show(resId)
    }

    private fun showReplacing(params: ToastParams) {
        cancel()
        Toaster.show(params)
    }
}
